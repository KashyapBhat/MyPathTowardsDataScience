...
* **Automated paper evaluation** (https://github.com/KashyapBhat/AumatedPaperEvaluation): *A project we took up in college to help teachers/lecturers evaluate examination papers easily using the power of Machine Learning.* 
